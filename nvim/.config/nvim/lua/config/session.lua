...
require("session_manager").setup({
  ...
  -- files.
  path_replacer = '__',
  -- The character to which the colon symbol will be replaced for session
  -- files.
  colon_replacer = '++',
  ...
  -- All buffers of these file types will be closed before the session is
  -- saved. 
  autosave_ignore_filetypes = {
    'gitcommit',
  },
  -- Always autosaves session. If true, only autosaves after a session is
  -- active. 
